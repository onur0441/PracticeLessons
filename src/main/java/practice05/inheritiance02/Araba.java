package practice05.inheritiance02;
...
public class Araba {
   ...
   //bütün objeler için ortak olmasını istiyorsak static yapabiliriz.
   // değişken olanları instance tanımlarız.
   // static bir yerden değişince heryerden değişeceği için çok tercih edilmez.esnek değildir.
